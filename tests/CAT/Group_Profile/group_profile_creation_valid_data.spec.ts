...
test.describe('One Portal CAT - Group Profile Creation With Valid Data', () => {
  ...
  test('GP-051 Verify Creating Dispatch group profile with valid data', async ({ page }) => {
  ...
  test('GP-052 Verify Creating Broadcast group profile with valid data', async ({ page }) => {
    await wcsrLogin(page);
    pageObj = new CATPage(page);
