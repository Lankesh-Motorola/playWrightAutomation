...
test.describe('CAT - Create and Verify Standard InterOp Talkgroup', () => {
  ...
  test('TG-020: Create Standard InterOp Talkgroup', async ({ page }) => {
    ...
    // Create standard talkgroup with interop flag (second parameter = true)
    await pageObj.createStandardTalkGr('Standard_InterOp_TalkGroup', true, false, 'TalkGr_Assign_User');
  ...
  test('TG-021: Delete Standard InterOp Talkgroup', async ({ page }) => {
    await pageObj.visitTalkGroup();
