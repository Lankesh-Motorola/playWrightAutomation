...
import { launchAndGetNewPageObject, wcsrLogin } from '../../../helpers/common';
...
test.describe('One Portal CAT - Interop User', () => {
  ...
  test('IT-001 Verify navigating to the Interop Connection and verify the fields', async ({ page, context }) => {
    ...
    await newPageObj.checkVisibility(pageObj.getSearchBox());
    await newPageObj.checkVisibility(pageObj.getAdvanceFilter());
  });
