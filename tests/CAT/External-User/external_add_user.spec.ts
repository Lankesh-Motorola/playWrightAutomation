...
test.describe('One Portal CAT - External User Add', () => {
  ...
  test('Ex-056 Verify Add External User Button has to be enabled by default and functionality of Add External user Button', async ({ page }) => {
    await wcsrLogin(page);
  ...
  test('Ex-057 Verify the default state of Save and Cancel button on add external Page', async ({ page }) => {
    await wcsrLogin(page);
    pageObj = new CATPage(page);
  ...
  test('Ex-058 Verify the Name and Phone input field to show some error message if we do not pass any input', async ({ page }) => {
    await wcsrLogin(page);
    pageObj = new CATPage(page);
  ...
  test('Ex-059 Verify Create External User Subscriber and Success message after creating external User', async ({ page }) => {
    await wcsrLogin(page);
    pageObj = new CATPage(page);
  ...
  test('Ex-060 Validate Create External subscriber using special characters Name', async ({ page }) => {
    await wcsrLogin(page);
    pageObj = new CATPage(page);
